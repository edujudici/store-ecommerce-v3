...
Route::name('api.')->group(static function () {
    ...
    // routes mercadolivre
    Route::post('ml/loads/single-product', [LoadController::class, 'singleProduct'])->name('load.single.product');
    Route::post('ml/loads/multiple-products', [LoadController::class, 'multipleProducts'])->name('load.multiple.products');
    Route::post('ml/loads/questions', [LoadController::class, 'questions'])->name('load.questions');
    Route::get('ml/loads/products/history', [LoadHistoryController::class, 'indexProduct'])->name('load.product.history');
    Route::get('ml/loads/questions/history', [LoadHistoryController::class, 'indexQuestion'])->name('load.question.history');
    Route::get('ml/dashboard', [MercadoLivreDashboardController::class, 'index'])->name('mercadolivre.dashboard.index');
