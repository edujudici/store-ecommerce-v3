                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-12 mb-4">
                                    <input id="email" type="email" class="input-lg form-control @error('email') is-invalid @enderror"
                                        aria-describedby="emailHelp" placeholder="E-mail" name="email" value="{{ old('email') }}" required autocomplete="email">
                                ...
                                <div class="form-group mb-0 col-md-12">
                                    ...
                                    <p> Para voltar
                                        <a class="text-blue" href="{{ route('painel.dashboard.index') }}">Clique aqui</a>
                                    </p>
                                </div>
                            </div>
                        </form>
