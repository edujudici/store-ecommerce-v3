        ...
        <div class="row">
            <div class="col-lg-12  col-md-12 col-sm-12 mb-5">
                <div class="single-footer-widget">
                    <h6 class="text-center">NEWSLETTER! Cadastre-se e receba todas as novidades de promoção e conteúdo.
                    </h6>
                    <p class="text-center">Seja o primeiro a saber sobre nossas últimas tendências e obtenha ofertas
                        exclusivas</p>
                    <div>
                        <form class="form-inline">
                            <div class="col-lg-8  col-md-8 col-sm-12 offset-lg-2 offset-md-2 offset-sm-0">
                                <div class="d-flex flex-row justify-content-center">
                                    <input class="form-control mr-3" name="EMAIL" placeholder="Digite seu Email"
                                        onfocus="this.placeholder = ''" onblur="this.placeholder = 'Digite seu e-mail '"
        ...
        <div class="row">
            ...
            <div class="col-lg-2  col-md-6 col-sm-6 mb-3">
                <div class="single-footer-widget">
                    ...
                    <img src="https://imgmp.mlstatic.com/org-img/MLB/MP/BANNERS/tipo2_125X125.jpg?v=1"
                        alt="Mercado Pago - Meios de pagamento" title="Mercado Pago - Meios de pagamento" width="125"
                        height="125" />
                </div>
            </div>
            <div class="col-lg-4  col-md-6 col-sm-6 mb-3">
                <div class="single-footer-widget">
                    ...
                    <div class="fb-page" data-href="https://www.facebook.com/imperiodomdf1" data-width="300"
            ...
            <div class="col-lg-4  col-md-6 col-sm-6 mb-3">
                <div class="single-footer-widget">
                    ...
                    <a target="_blank" href="https://letsencrypt.org/">
                        <img class="mr-3" src="{{ asset('assets/site/img/letsencrypt.png') }}" alt="Selo segurança"
                            title="Selo segurança" width="80" height="80" />
                    </a>
                    <a target="_blank" href="https://www.mercadopago.com.br/">
                        <img class="mr-3" src="{{ asset('assets/site/img/mercadopago.jpg') }}" alt="Selo segurança"
                            title="Selo segurança" width="80" height="80" />
                    </a>
                    <a target="_blank"
